...
namespace MusicProject.IocConfig
{
  public static class AddIdentityOptionsExtensions
  {
    ...
    public const string MobileConfirmationTokenProviderName = "ConfirmEmail";
            ...
            this IServiceCollection services, SiteSettings siteSettings)
    {
      ...
      services.addConfirmMobileDataProtectorTokenOptions(siteSettings);
    ...
    private static void addConfirmMobileDataProtectorTokenOptions(this IServiceCollection services, SiteSettings siteSettings)
    {
      services.Configure<IdentityOptions>(options =>
      {
        options.Tokens.ChangePhoneNumberTokenProvider = MobileConfirmationTokenProviderName;
      });
