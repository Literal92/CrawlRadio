		...
		var $container			= $( '#container' ),
			...
			_goto				= function( chapter ) {
				...
				var chapter 	= chapter || History.getState().url.queryStringToJSON().page,
					...
					$article = $(chapter ? '#' + 'chapter' + chapter : '#' + 'chapterintroduction');
					
					$('#link_introduction').removeClass('active');
					$('#link_about').removeClass('active');
					$('#link_oprate').removeClass('active');
					$('#link_generaloptions').removeClass('active');
					$('#link_architecturalfeatures').removeClass('active');
					$('#link_investment').removeClass('active');
					$('#link_pioneer').removeClass('active');
					$('#link_articles').removeClass('active');
					$('#link_expo').removeClass('active');
					$('#link_news').removeClass('active');
					$('#link_gallery').removeClass('active');
					$('#link_clip').removeClass('active');
					$('#link_campign1').removeClass('active');
					$('#link_campign2').removeClass('active');
					$('#link_campign3').removeClass('active');
					$('#link_register').removeClass('active');
					$('#link_request').removeClass('active');
					$('#link_c').removeClass('active');
					$('#link_karbari').removeClass('active');
					$('#link_sakenin').removeClass('active');
					$('#link_foroosh').removeClass('active');
					$('#link_contact').removeClass('active');
					$('#link_stuff').removeClass('active');
					$('#link_catalog').removeClass('active');
